...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>random-stuff/algebra/cryptography/caesar_cipher/test_code_helper.py at master · flaviamissi/random-stuff · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="BB1448E5:1FA5:DCC9EC1:525FE292" name="octolytics-dimension-request_id" />
...
<meta content="a3lLM3rXZVZxFtOvo/lwKAjjv907dRCcUl6zv0QzF+I=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-ebc981e499faa002b029a97084129b1c987eea09.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="8137393e616be5d5d81398147cfe2e77">
        ...
        <link data-pjax-transient rel='permalink' href='/flaviamissi/random-stuff/blob/68891b203dca24e83ba70e768948a0ead14220b6/algebra/cryptography/caesar_cipher/test_code_helper.py'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fflaviamissi%2Frandom-stuff%2Fblob%2Fmaster%2Falgebra%2Fcryptography%2Fcaesar_cipher%2Ftest_code_helper.py">Sign in</a>
    </div>
...
<!-- blob contrib key: blob_contributors:v21:3486a0e5d75a398f0ca8abf3aeea5d55 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/flaviamissi/random-stuff/blob/master/algebra/cryptography/caesar_cipher/test_code_helper.py"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/flaviamissi/random-stuff/raw/master/algebra/cryptography/caesar_cipher/test_code_helper.py" class="button minibutton " id="raw-url">Raw</a>
            <a href="/flaviamissi/random-stuff/blame/master/algebra/cryptography/caesar_cipher/test_code_helper.py" class="button minibutton ">Blame</a>
          <a href="/flaviamissi/random-stuff/commits/master/algebra/cryptography/caesar_cipher/test_code_helper.py" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L10" rel="#L10">10</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="kn">import</span> <span class="nn">unittest</span></div><div class='line' id='LC2'><span class="kn">from</span> <span class="nn">code_helper</span> <span class="kn">import</span> <span class="n">CodeHelper</span></div><div class='line' id='LC3'><span class="kn">from</span> <span class="nn">nose.tools</span> <span class="kn">import</span> <span class="n">assert_equals</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="k">class</span> <span class="nc">CodeHelperTestCase</span><span class="p">(</span><span class="n">unittest</span><span class="o">.</span><span class="n">TestCase</span><span class="p">):</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">def</span> <span class="nf">setUp</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="bp">self</span><span class="o">.</span><span class="n">code_helper</span> <span class="o">=</span> <span class="n">CodeHelper</span><span class="p">()</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">def</span> <span class="nf">test_should_get_2_17_8_15_19_14_6_17_0_5_8_0_code_to_criptografia_word</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">assert_equals</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">code_helper</span><span class="o">.</span><span class="n">to_code</span><span class="p">(</span><span class="s">&quot;criptografia&quot;</span><span class="p">),</span> <span class="p">[</span><span class="mi">2</span><span class="p">,</span><span class="mi">17</span><span class="p">,</span><span class="mi">8</span><span class="p">,</span><span class="mi">15</span><span class="p">,</span><span class="mi">19</span><span class="p">,</span><span class="mi">14</span><span class="p">,</span><span class="mi">6</span><span class="p">,</span><span class="mi">17</span><span class="p">,</span><span class="mi">0</span><span class="p">,</span><span class="mi">5</span><span class="p">,</span><span class="mi">8</span><span class="p">,</span><span class="mi">0</span><span class="p">])</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.03172s from github-fe116-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
