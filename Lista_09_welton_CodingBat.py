...
# se a lista tiver menos de dois elementos, soma o que for possí­vel
def sum2(nums):
  if len(nums) == 0:
    return 0
  if len(nums) == 1:
...
# meio de a e b, suponha que as listas tem tamanho i­mpar
...
# H. squirrel_play
# os esquilos na FATEC brincam quando a temperatura estão entre 60 e 90
