...
# A. near_ten
# Seja um n não negativo, retorna True se o números estão a distância de
# pelo menos dois de um múltiplo de dez. Use a função resto da divisão.
# near_ten(12) -> True
# near_ten(17) -> False
# near_ten(19) -> True
def near_ten(n):
	return n % 10 in [0,1,2,8,9,10]

# B. lone_sum
# Soma maluca: some os númeross inteiros a, b, e c
...
# E. count_hi
# conta o números de vezes que aparece a string 'hi'
...
# F. cat_dog
# verifica se o aparece o mesmo números de vezes 'cat' e 'dog'
# cat_dog('catdog') -> True
...
# assim 'coxe' ou 'coze' tambémm são contadas como 'code'
...
# I. count_evens
# conta os númeross pares da lista
...
# 13 dá azar, você deverá ignorar o 13 e todos os números á sua direita
# sum13([1, 2, 2, 1]) -> 6
# sum13([1, 1]) -> 2
# sum13([1, 2, 2, 1, 13]) -> 6
# sum13([13, 1, 2, 3, 4]) -> 0
...
# K. has22
# Verifica se na lista de númeross inteiros aparecem dois 2 consecutivos
# has22([1, 2, 2]) -> True
# has22([1, 2, 1, 2]) -> False
# has22([2, 1, 2]) -> False
def has22(nums):
...
# L. soma_na_lista
# Verifica se um números são soma de dois elementos distintos de uma lista
...
# Ã© possível uma solução sem usar for ou while
